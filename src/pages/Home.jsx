        ...
        <div className="flex flex-col-reverse md:flex-row  justify-center mt-12  gap-4">
          ...
          <div className="w-full bg-[#54BAB9] dark:bg-[#354259] md:rounded-md hover:shadow-none shadow-2xl md:w-1/2">
            <div className="md:hidden flex items-center justify-between p-4 ">
              <Link to={"/createtask"}>
                <button className="bg-[#38938A] dark:bg-[#44A0A0] outline-none p-1 rounded-lg text-sm font-bold text-white w-[100px]">
                  ADD TASKS
                </button>
              </Link>
            ...
            <div className="md:space-y-3  md:p-0 bg-[#54BAB9] dark:bg-[#354259]">
              {task?.map((item) => {
                return (
                  <>
                    <div className="w-full p-2 text-left font-bold ">{item.date}</div>
                    <div
                      key={item.id}
